...
const Header = () => {
    ...
    return (
        <aside id="sidebar" class="fixed z-20 h-full top-0 left-0 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
                        ...
                        <ul class="space-y-2 pb-2">
                            <li>
                                <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    <img className="w-10/12 pl-7" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/OOjs_UI_icon_userAvatar.svg/1200px-OOjs_UI_icon_userAvatar.svg.png" />
                                </a>
                            </li>
                            <li>
                                <Link href="/">
                            ...
                            <li>
                                <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <span class="ml-3 flex-1 whitespace-nowrap">Mis Proyectos</span>
                            ...
                            <li>
                                <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <span class="ml-3 flex-1 whitespace-nowrap">Mis Acciones</span>
                            ...
                            <li>
                                <a href="http://localhost:3000/usuarios/naturales" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <span class="ml-3 flex-1 whitespace-nowrap">Mis Inversiones</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="http://localhost:3000/order/eleccion" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    ...
                                    <span class="ml-3 flex-1 whitespace-nowrap">Mis Prestamos</span>
                                </a>
                            </li>
                        </ul>
